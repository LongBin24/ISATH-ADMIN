export const ENDPOINTS = {
  ...
  NOTIFICATIONS_MARK_SEEN: "admin/notifications/mark-seen",
  ADMIN_NOTIFICATIONS_MARK_SEEN: "admin/notifications/mark-seen",
  NOTIFICATIONS_ACTIVITY_SUMMARY: "admin/notifications/activity-summary",
  ADMIN_NOTIFICATIONS_ACTIVITY_SUMMARY: "admin/notifications/activity-summary",
