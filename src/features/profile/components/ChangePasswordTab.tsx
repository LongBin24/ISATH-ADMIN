  ...
  return (
    <div className="grid gap-5 xl:grid-cols-[minmax(0,1.15fr)_minmax(280px,0.85fr)] font-google-sans">
      <Card className="rounded-2xl shadow-sm">
        <CardHeader>
          <div className="flex items-start gap-3"><span className="grid size-11 shrink-0 place-items-center rounded-xl bg-[#003377]/10 text-[#003377] dark:bg-[#FEDB55]/10 dark:text-[#FEDB55]"><KeyRound className="size-5" /></span><div><CardTitle className="text-xl font-bold text-[#003377] dark:text-[#FFC83D]">{t("Change Password")}</CardTitle><CardDescription className="mt-1">{t("Choose a strong password that you do not use for another account.")}</CardDescription></div></div>
        </CardHeader>
        <CardContent>
      ...
      <Card className="h-fit rounded-2xl shadow-sm">
        <CardHeader><CardTitle className="flex items-center gap-2 text-xl font-bold text-[#003377] dark:text-[#FFC83D]"><ShieldCheck className="size-5 text-[#003377] dark:text-[#FEDB55]" />{t("Password Requirements")}</CardTitle><CardDescription>{t("Use these guidelines to keep your administrator account secure.")}</CardDescription></CardHeader>
