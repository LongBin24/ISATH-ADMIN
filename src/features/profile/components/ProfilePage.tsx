...
function ProfileSkeleton() { return <div className="mx-auto max-w-7xl space-y-6"><div className="space-y-2"><Skeleton className="h-9 w-56" /><Skeleton className="h-5 w-96 max-w-full" /></div><Skeleton className="h-64 rounded-3xl" /><Skeleton className="h-16 rounded-2xl" /><div className="grid gap-5 xl:grid-cols-[1.35fr_0.65fr]"><Skeleton className="h-96 rounded-2xl" /><div className="space-y-5"><Skeleton className="h-48 rounded-2xl" /><Skeleton className="h-48 rounded-2xl" /></div></div></div>; }
